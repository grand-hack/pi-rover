...
FUNCTIONS = {
    0: None,
    1: RemoteControl,    # 运动控制(motion control)
    2: ColorDetect,      # 颜色识别(color detect)
    3: ColorTracking,    # 颜色追踪(color tracking)
    4: VisualPatrol,     # 视觉巡线(visual patrol)
    5: QuickMark,        # 二维码识别(QR code recognition)
    6: Avoidance,        # 智能避障(intelligent avoidance)
    7: None, 
    8: None,
